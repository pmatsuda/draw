var draw = (function() {
	...
	// Get the height and width of the main we will use this set canvas to the
	// full
	// size of the main element.
	var mWidth = document.querySelector('main').offsetWidth, mHeight = document
			.querySelector('main').offsetHeight,
